...
1. Fetch each blog post; if needed, continue fetching additional chunks until complete.
   These are separate blog-page fetches and must not be confused with retrieval of the publications gist.
...
- Ensure that the links are relevant to the topic of VSCode or Theia dependent on the user question.
